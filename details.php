...
<html lang="en">
  <head>
    ...
    <title>Details | AditPedia</title>

    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet" />
    <link href="assets/style/main.css" rel="stylesheet" />
    <link rel="icon" href="assets/images/Logo Kecil.png">
  </head>
    ...
    >
      <div class="container">
        <a href="index.php" class="navbar-brand" title="home">
          <img src="assets/images/Logo Komputerku (DARK).png" alt="logo" width="150px" />
        </a>
        <button
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 d-flex justify-content-between">
                ...
                <div>
                  <p>
                    Tersedia : <strong><?= $product["stock"]; ?> Pcs</strong>
                  </p>
                </div>
              </div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">
              &copy; 2021 Copyright by AditPedia. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
