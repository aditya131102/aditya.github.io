      ...
      <section class="store-landing">
        <div class="container">
          <div class="row align-items-center justify-content-between">
            <div class="col-md-5">
              <img src="assets/images/logo.png" class="w-auto" alt="logo" />
            </div>
            <div class="col-md-6">
              <h1 style="font-weight: bold; margin-bottom: 15px;">AditPedia</h1>
              <p class="store-subtitle-landing" style="line-height: 28px; color: rgb(146, 146, 146);">
              Toko belanja online berbasis web yang menyediakan kebutuhan-kebutuhan anda. Kami selalu
              mengedepankan kepuasan pelanggan dengan cara kemudahan untuk mengakses AditPedia.
              </p>
                  ...
                  <div class="row justify-content-center align-content-center">
                    <div class="col-10 col-md-4">
                      <div class="adventeges-thumbnail mb-lg-0 mb-2">
                        <img
                          src="assets/images/cepat kilat.png"
                          class="w-100"
                          alt=""
                        />
                      </div>
                    ...
                    <div class="col-md-8">
                      ...
                      >
                        <div class="title-text">Pengiriman Kilat</div>
                        <div class="subtitle-text">
                          Pengeririman secepat kilat tanpa hambatan.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text">Murah Meriah</div>
                        <div class="subtitle-text">
                          Murah tanpa biaya tambahan apapun.
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <div class="row justify-content-center align-content-center">
                    <div class="col-10 col-md-4">
                      <div class="adventeges-thumbnail mb-lg-0 mb-2">
                        <img src="assets/images/best quality.png" class="w-100" alt="" />
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text">Best Quality</div>
                        <div class="subtitle-text">
              ...
              >
                ...
                <a href="details.php?id=<?= $idProduct; ?>" class="component-products d-block">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                      <div class="text-muted"><?= $product["stock"]; ?> pcs</div>
                    </div>
                  </div>
                </a>
                <?php else : ?>
