...
<html lang="en">
  <head>
    ...
    <title>About Us | AditPedia</title>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <h1 class="" style="font-size: 60px;">AditPedia</h1>
              <h5 class="">Toko Online Serba Ada</h5>
              <a
                  href="https://wa.me/6281214562236"
                  target="_blank"
        ...
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              ...
              <h2 class="font-weight-bold mb-2">AditPedia</h2>   
              <hr style="border-top: 5px solid black; width: 80px;">
            </div>
          </div>
          <div class="row text-center">
            <div class="col-md-12">
              <p>Penyedia layanan belanja online yang mengedepankan kepuasan pelanggan dan mampu bersaing dengan kompetitor.</p>
            </div>
          </div>
          ...
          <div class="row justify-content-center text-center">
            <div class="col-md-6">
                <h5>Visi</h5>
                <p>Menjadi perusahaan yang menyediakan berbagai macam kebutuhan dan layanan terbaik.</p>
            </div>
            <div class="col-md-6">
                <h5>Misi</h5>
                <p>Meningkatkan daya produksi agar kebutuhan masyarakat terpenuhi dengan maksimal.</p>
            </div>
          </div>
          <div class="row text-center" style="margin-top: 100px;">
            <div class="col-12">
              <h2 class="font-weight-bold">Founder</h2>
              <hr style="border-top: 5px solid black; width: 80px;">
            </div>
          </div>
          <div class="row justify-content-center text-center">
            <div class="col-md-6" width="1px">
                <img src="assets/images/adit.jpg" alt="logo" width="500px"/>
                <h5><br>Aditya Haryanto Ramdhani</h5>
                <p>Always Be Thankful For Everything You Have</p>
            </div>
          </div>
        </div>
      </section>
